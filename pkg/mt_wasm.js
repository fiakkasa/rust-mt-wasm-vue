 ...
 * @returns {number}
 */
export function parallel_sum(numbers) {
    const ptr0 = passArray32ToWasm0(numbers, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parallel_sum(ptr0, len0);
    return ret >>> 0;
}
 ...
 */
export function parallel_sum_async(numbers) {
    const ptr0 = passArray32ToWasm0(numbers, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parallel_sum_async(ptr0, len0);
    return ret;
}
